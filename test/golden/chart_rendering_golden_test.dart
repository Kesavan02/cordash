...
void main() {
  group('Chart CustomPainter Visual Rendering Tests', () {
    testWidgets(
      'StepsChartPainter renders empty state cleanly without exceptions',
      (tester) async {
        ...
        expect(
          find.byWidgetPredicate(
            (w) => w is CustomPaint && w.painter is StepsChartPainter,
          ),
          findsOneWidget,
        );
      },
    ...
    testWidgets(
      'HeartRateChartPainter renders smooth bezier curve and gradient fill',
      (tester) async {
        final now = DateTime(2026, 9, 17, 10, 0);
        ...
        expect(
          find.byWidgetPredicate(
            (w) => w is CustomPaint && w.painter is HeartRateChartPainter,
          ),
          findsOneWidget,
        );
      },
    ...
    testWidgets(
      'ChartContainer handles tap gestures and updates tooltip query',
      (tester) async {
        String? queriedValue;
